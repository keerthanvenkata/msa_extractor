...
- All 22 fields now have complete template references (clause excerpts, sample answers, clause names)

**Benefits:**
- Consistent extraction against standards
- Better match flag accuracy
- Template compliance tracking
- Complete template coverage for all fields

### 6. Field Metadata

**What Changed:**
- Added field metadata to `FIELD_INSTRUCTIONS`:
...
- All 22 fields populated with metadata
- Metadata used for LLM context (not part of response schema)

**Benefits:**
- Better extraction guidance for LLM
- Clear distinction between negotiable and non-negotiable fields
- Template compliance understanding

### 7. Negotiable Fields Guidance

**What Changed:**
- Explicit prompt guidance for negotiable fields
- Match flags reflect structural similarity, not value similarity for negotiable fields
- Clear distinction between negotiable and non-negotiable field handling

**Benefits:**
- Accurate match flag assignment for negotiable fields
...
- [ADR-0012: Negotiable Fields Guidance](architecture/adr/0012-negotiable-fields-guidance.md)
- [ADR-0013: Template References Approach](architecture/adr/0013-template-references-approach.md)
