...
class SchemaValidator:
    ...
    def normalize(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        All fields use enhanced structure with extracted_value, match_flag, and validation.
